...
/**
 * _erratoi - to convert a string to an int
 * @s: the string to be conv
 * Return: 0 and -1 on error
 * Authors: Azizi Nyawa and Ronald
 */
int _erratoi(char *s)
{
	int i = 0;
...
/**
 * print_d - function prints decimal to int base 10
...
/**
 * convert_number - converter same as iot
 * @num: number
 * @base: base
